  ...
  <div id="solverd-getstarted">
    ...
    <Section id="getstarted-links" aria-labelledby="getstarted-links-title" class="text-center">
      ...
      <div class="action-link-container">
        <ActionLink href="#getstarted-releases-section">View current releases</ActionLink>
    ...
    <Section id="getstarted-learnmore" aria-labelledby="getstarted-learnmore-title">
    ...
    <Section id="getstarted-releases" aria-labelledby="getstarted-releases-title">
...
export default {
  data () {
    return {
      packages: {},
      images: {
        rd3Overview: require('../src/assets/rd3-data-flow.png')
      }
    }
  },
  components: {
